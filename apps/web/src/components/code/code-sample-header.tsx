...
export function CodeSampleHeader({
  sample,
}: CodeSampleHeaderProps) {
    ...
    <header className="border-line border-b">
      <div className="mx-auto w-full max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-10 lg:py-24">
        ...
        <div className="mt-9 max-w-5xl">
          ...
          <p className="text-secondary mt-6 max-w-4xl text-lg leading-8">
            {sample.summary}
          </p>
        </div>
        ...
        {technologies.length > 0 ? (
          <div
            ...
            aria-label="Technologies used in this sample"
          >
