...
declare global {
  var portfolioContactRateLimit:
    | Map<string, RateLimitEntry>
    | undefined;
}

const rateLimitStore =
  globalThis.portfolioContactRateLimit ??
...
function getSmtpConfig(): SmtpConfig | null {
  ...
  const rateLimitSalt =
    process.env.CONTACT_RATE_LIMIT_SALT?.trim();
    ...
    return jsonResponse(
      {
        ...
        code: "invalid_json",
        message:
          "The submitted form is not valid JSON.",
        requestId,
      },
      400,
      requestId,
    ...
    return jsonResponse(
      {
        ...
        message:
          "Review the form fields and submit again.",
        fieldErrors:
    ...
    return jsonResponse(
      {
        ...
        message:
          "Please reload the page and submit the form again.",
        requestId,
      },
      400,
      requestId,
